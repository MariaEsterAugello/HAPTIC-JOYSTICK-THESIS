...
#define S_FUNCTION_NAME  udpsend_int16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetInputPortDataType(S, INPUT_SIGNAL, SS_INT16);
    ssSetInputPortRequiredContiguous(S,INPUT_SIGNAL, 1);
    //TODO: controllare il resto del codice per modifiche necessarie alla modifica del inputtype  
    //      come ad esempio allocazioni di buffer etc 
...
static void mdlOutputs(SimStruct *S, int_T tid) 
{
    ...
    void *	input	= ssGetInputPortSignal(S,INPUT_SIGNAL);
	...
	ret = send(sockfd, (const char FAR *)input, sizeof(int16_T) * SIGNAL_SIZE, 0);
